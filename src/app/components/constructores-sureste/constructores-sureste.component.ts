...
@Component({
  selector: 'app-constructores-sureste',
  templateUrl: './constructores-sureste.component.html',
  styleUrls: ['./constructores-sureste.component.css']
})
export class ConstructoresSuresteComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[1].Sureste;
