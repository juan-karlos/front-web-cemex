...
@Component({
  selector: 'app-suministro-noreste',
  templateUrl: './suministro-noreste.component.html',
  styleUrls: ['./suministro-noreste.component.css']
})
export class SuministroNoresteComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[0].Noreste;
