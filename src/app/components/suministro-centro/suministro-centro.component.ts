...
@Component({
  selector: 'app-suministro-centro',
  templateUrl: './suministro-centro.component.html',
  styleUrls: ['./suministro-centro.component.css']
})
export class SuministroCentroComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[0].Centro;
