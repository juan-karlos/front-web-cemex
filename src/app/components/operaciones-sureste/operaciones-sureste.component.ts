...
@Component({
  selector: 'app-operaciones-sureste',
  templateUrl: './operaciones-sureste.component.html',
  styleUrls: ['./operaciones-sureste.component.css']
})
export class OperacionesSuresteComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[4].Sureste;
