...
@Component({
  selector: 'app-industriales-centro',
  templateUrl: './industriales-centro.component.html',
  styleUrls: ['./industriales-centro.component.css']
})
export class IndustrialesCentroComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[2].Centro;
