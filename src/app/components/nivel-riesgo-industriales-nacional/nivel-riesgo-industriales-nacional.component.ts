...
@Component({
  selector: 'app-nivel-riesgo-industriales-nacional',
  templateUrl: './nivel-riesgo-industriales-nacional.component.html',
  styleUrls: ['./nivel-riesgo-industriales-nacional.component.css']
})

export class NivelRiesgoIndustrialesNacionalComponent implements OnInit{
