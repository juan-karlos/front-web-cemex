...
@Component({
  selector: 'app-industriales-noreste',
  templateUrl: './industriales-noreste.component.html',
  styleUrls: ['./industriales-noreste.component.css']
})
export class IndustrialesNoresteComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[2].Noreste;
