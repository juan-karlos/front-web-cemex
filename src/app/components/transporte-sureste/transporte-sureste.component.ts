...
@Component({
  selector: 'app-transporte-sureste',
  templateUrl: './transporte-sureste.component.html',
  styleUrls: ['./transporte-sureste.component.css']
})
export class TransporteSuresteComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[6].Sureste;
