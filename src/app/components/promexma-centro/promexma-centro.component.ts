...
@Component({
  selector: 'app-promexma-centro',
  templateUrl: './promexma-centro.component.html',
  styleUrls: ['./promexma-centro.component.css']
})
export class PromexmaCentroComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[5].Centro;
