...
@Component({
  selector: 'app-suministro-sureste',
  templateUrl: './suministro-sureste.component.html',
  styleUrls: ['./suministro-sureste.component.css']
})
export class SuministroSuresteComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[0].Sureste;
