...
@Component({
  selector: 'app-nivel-riesgo-operaciones-nacional',
  templateUrl: './nivel-riesgo-operaciones-nacional.component.html',
  styleUrls: ['./nivel-riesgo-operaciones-nacional.component.css']
})

export class NivelRiesgoOperacionesNacionalComponent implements OnInit{
