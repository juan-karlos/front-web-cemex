...
@Component({
  selector: 'app-operaciones-centro',
  templateUrl: './operaciones-centro.component.html',
  styleUrls: ['./operaciones-centro.component.css']
})
export class OperacionesCentroComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[4].Centro;
