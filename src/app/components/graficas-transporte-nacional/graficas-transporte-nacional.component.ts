...
@Component({
  selector: 'app-graficas-transporte-nacional',
  templateUrl: './graficas-transporte-nacional.component.html',
  styleUrls: ['./graficas-transporte-nacional.component.css']
})
export class GraficasTransporteNacionalComponent implements OnInit {
...
//   // Asegúrate de que las propiedades sean correctas y coincidan con las reales
//   const pacifico = datos[18].zona;
//   const norte = datos[16].zona;
//   const sur = datos[17].zona;
//   const centro = datos[19].zona;
//   const nacional = datos[19].nacional;
