...
@Component({
  selector: 'app-constructores-noreste',
  templateUrl: './constructores-noreste.component.html',
  styleUrls: ['./constructores-noreste.component.css']
})
export class ConstructoresNoresteComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[1].Noreste;
