...
@Component({
  selector: 'app-constructores-nacional',
  templateUrl: './constructores-nacional.component.html',
  styleUrls: ['./constructores-nacional.component.css']
})

export class ConstructoresNacionalComponent implements OnInit {
