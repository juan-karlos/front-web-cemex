...
@Component({
  selector: 'app-nivel-riesgo-transporte-nacional',
  templateUrl: './nivel-riesgo-transporte-nacional.component.html',
  styleUrls: ['./nivel-riesgo-transporte-nacional.component.css']
})
export class NivelRiesgoTransporteNacionalComponent {
