...
@Component({
  selector: 'app-operaciones-noreste',
  templateUrl: './operaciones-noreste.component.html',
  styleUrls: ['./operaciones-noreste.component.css']
})
export class OperacionesNoresteComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[4].Noreste;
