...
@Component({
  selector: 'app-suministro-pacifico',
  templateUrl: './suministro-pacifico.component.html',
  styleUrls: ['./suministro-pacifico.component.css']
})
export class SuministroPacificoComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[0].Pacífico;
