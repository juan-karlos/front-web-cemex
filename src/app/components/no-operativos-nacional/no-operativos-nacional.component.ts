...
@Component({
  selector: 'app-no-operativos-nacional',
  templateUrl: './no-operativos-nacional.component.html',
  styleUrls: ['./no-operativos-nacional.component.css']
})

export class NoOperativosNacionalComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =(datos[3].Total)/4
