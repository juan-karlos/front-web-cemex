...
@Component({
  selector: 'app-operaciones-nacional',
  templateUrl: './operaciones-nacional.component.html',
  styleUrls: ['./operaciones-nacional.component.css']
})

export class OperacionesNacionalComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =(datos[4].Total)/4;
