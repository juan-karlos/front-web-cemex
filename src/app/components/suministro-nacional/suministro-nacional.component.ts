...
@Component({
  selector: 'app-suministro-nacional',
  templateUrl: './suministro-nacional.component.html',
  styleUrls: ['./suministro-nacional.component.css']
})
export class SuministroNacionalComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =(datos[0].Total)/4;
