...
@Component({
  selector: 'app-transporte-pacifico',
  templateUrl: './transporte-pacifico.component.html',
  styleUrls: ['./transporte-pacifico.component.css']
})
export class TransportePacificoComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[6].Pacífico;
