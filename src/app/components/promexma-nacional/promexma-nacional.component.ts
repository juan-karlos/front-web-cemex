...
@Component({
  selector: 'app-promexma-nacional',
  templateUrl: './promexma-nacional.component.html',
  styleUrls: ['./promexma-nacional.component.css']
})

export class PromexmaNacionalComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =(datos[5].Total)/4;
