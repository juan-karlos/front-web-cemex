...
@Component({
  selector: 'app-transporte-centro',
  templateUrl: './transporte-centro.component.html',
  styleUrls: ['./transporte-centro.component.css']
})
export class TransporteCentroComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[6].Centro;
