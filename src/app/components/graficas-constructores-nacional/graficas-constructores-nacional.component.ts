...
@Component({
  ...
  templateUrl: './graficas-constructores-nacional.component.html',
  styleUrls: ['./graficas-constructores-nacional.component.css']
})

export class GraficasConstructoresNacionalComponent implements OnInit {
