...
@Component({
  selector: 'app-operaciones-pacifico',
  templateUrl: './operaciones-pacifico.component.html',
  styleUrls: ['./operaciones-pacifico.component.css']
})
export class OperacionesPacificoComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[4].Pacífico;
