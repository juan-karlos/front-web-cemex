...
@Component({
  selector: 'app-industriales-nacional',
  templateUrl: './industriales-nacional.component.html',
  styleUrls: ['./industriales-nacional.component.css']
})

export class IndustrialesNacionalComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =(datos[2].Total)/4;
