...
@Component({
  selector: 'app-no-operativos-pacifico',
  templateUrl: './no-operativos-pacifico.component.html',
  styleUrls: ['./no-operativos-pacifico.component.css']
})
export class NoOperativosPacificoComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[3].Pacífico
