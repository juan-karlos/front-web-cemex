...
@Component({
  ...
  templateUrl: './graficas-promexma-nacional.component.html',
  styleUrls: ['./graficas-promexma-nacional.component.css']
})
export class GraficasPromexmaNacionalComponent implements OnInit {
