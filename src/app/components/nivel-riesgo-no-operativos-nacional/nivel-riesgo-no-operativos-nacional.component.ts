...
@Component({
  selector: 'app-nivel-riesgo-no-operativos-nacional',
  templateUrl: './nivel-riesgo-no-operativos-nacional.component.html',
  styleUrls: ['./nivel-riesgo-no-operativos-nacional.component.css']
})

export class NivelRiesgoNoOperativosNacionalComponent implements OnInit{
