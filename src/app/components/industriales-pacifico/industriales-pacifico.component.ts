...
@Component({
  selector: 'app-industriales-pacifico',
  templateUrl: './industriales-pacifico.component.html',
  styleUrls: ['./industriales-pacifico.component.css']
})
export class IndustrialesPacificoComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[2].Pacífico;
