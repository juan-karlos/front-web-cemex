...
@Component({
  selector: 'app-nivel-riesgo-suministro-nacional',
  templateUrl: './nivel-riesgo-suministro-nacional.component.html',
  styleUrls: ['./nivel-riesgo-suministro-nacional.component.css']
})
export class NivelRiesgoSuministroNacionalComponent implements OnInit{
