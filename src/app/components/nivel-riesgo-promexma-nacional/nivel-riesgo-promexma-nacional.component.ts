...
@Component({
  selector: 'app-nivel-riesgo-promexma-nacional',
  templateUrl: './nivel-riesgo-promexma-nacional.component.html',
  styleUrls: ['./nivel-riesgo-promexma-nacional.component.css']
})

export class NivelRiesgoPromexmaNacionalComponent implements OnInit{
