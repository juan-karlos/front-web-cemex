...
@Component({
  selector: 'app-transporte-noreste',
  templateUrl: './transporte-noreste.component.html',
  styleUrls: ['./transporte-noreste.component.css']
})
export class TransporteNoresteComponent implements OnInit {
  ...
  obtenerPorcentajeZonaSegmentos(){
    this.logicaService.getProcentajeCumplimietoZonasSegmentos().subscribe(
      ...
      (datos) => {
       ...
       const PorcentajeEnTiempoReal =datos[6].Noreste;
